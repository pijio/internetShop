...
values
(true,6,'Notebook HP Pavilion 15,5', 3, 'Не нужно ничем жертвовать - этот тонкий и мощный игровой ноутбук HP Pavilion безупречен во всем. Высококачественная графика и впечатляющая вычислительная мощность позволяют играть и выполнять
...
(true,6,'Ноутбук HP ProBook 650 G8',3,'Современный дизайн для офиса.
...
(true,6,'Ноутбук HP ProBook 450 G7',3,'Мощь бизнес-класса по доступной цене
...
(true,6,'HP Victus 16-e0073ur',4,'Ноутбук Victus от HP с диагональю 16,1 дюйма, оснащенный процессором AMD, обладает всеми необходимыми функциями как для игр, так и для решения повседневных задач. Расширь свои возможности с пом
...
(true,6,'HP ZBook 15 Studio G8',5,'От клавиатуры до экрана - каждый аспект ZBook Studio предназначен для рабочих процессов и производительности. Визуализируйте в режиме реального времени, сотрудничайте удаленно и даже играйте из
...
(true,6,'HP Elite Dragonfly G2',2,'Это потрясающее устройство почти у вас в руках
...
(true,6,'HP EliteBook 850 G7',4,'Ноутбук, который никогда не подведет
...
(true,6,'HP Spectre x360',3,'Невероятно реалистичное изображение
...
ии.',8,114300,8,8,8,1),
(true,6,'HP ProBook 450 G8',3,'Мощь бизнес-класса по доступной цене
Этот полнофункциональный, тонкий, легкий и надежный HP ProBook 450 предоставляет всю необходимые возможности для любого бизнеса по доступной цене. Автоматические функции безопасности, высочайшая производительность и длительное время
 работы от аккумулятора помогают поддерживать максимальную эффективность вашего бизнеса.',9,114300,9,9,9,1),
(true,2,'HP Color LaserJet CP5225dn',2,'Этот универсальный и недорогой настольный принтер A3 позволяет печатать деловую документацию любого формата - от почтовых открыток до крупноформатных документов. Тонер HP ColorSphere, высо
...
(true,2,'HP Color LaserJet M555x',5,'Идеальный выбор для предприятий с 5-15 сотрудниками и объемами печати до 10 000 страниц в месяц, которым требуется высококачественная цветная печать, а также быстрое сканирование и копирован
ие.',11,8138,11,11,11,1),
(true,2,'HP Color LaserJet M653dn',3,'Этот принтер HP Color LaserJet с технологией JetIntelligence сочетает в себе исключительную производительность, пониженное энергопотребление и надежную печать документов профессионального ка
чества, при этом защищая вашу сеть с помощью встроенных средств обеспечения безопасности HP.',12,9490,12,12,12,1),
(true,3,'HP Color LaserJet M776zs',4,'Эти усовершенствованные МФУ, оснащенные технологией JetIntelligence, обеспечивают великолепные цветные отпечатки. Экономьте время и упростите рабочие процессы благодаря самым безопасным уст
...
(true,2,'HP Color LaserJet M183fw',5,'Работайте там, где удобно
...
(true,3,'HP Color LaserJet M227sdn',3,'МФУ HP LaserJet Pro с картриджами JetIntelligence обеспечат более высокий уровень производительности и защиты. Задайте новые стандарты скорости для вашего бизнеса. Выполняйте быструю двусто
...
(true,4,'HP Omen GT13-1001ur',3,'Надежный ПК OMEN 30L с быстрым процессором Intel и мощной видеокартой NVIDIAR отличается стильным дизайном и позволит тебе играть на высшем уровне.',16,350000,16,16,16,1),
(true,4,'HP ProDesk 400 G7 SFF',2,'Компактный и надежный HP ProDesk 400 оснащен функциями безопасности. Его производительность можно масштабировать вместе с вашим бизнесом.',17,67000,17,17,17,1),
(true,4,'HP ProDesk 400 G7 MT',1,'Надежность и готовность к расширению возможностей по мере развития бизнеса
...
(true,4,'HP Z VR BackPack G2',5,'Раскройте потенциал VR с рабочей станцией, которая всегда под рукой. Передовые возможности и невероятная мощность в компактном переносимом устройстве.',19,172700,19,19,19,1),
(true,5,'Картридж HP 656X',4,'Оригинальные лазерные картриджи HP с технологией JetIntelligence обеспечивают печать рекордного количества страниц с высокой скоростью. Можно выбрать доступные по цене модели с увеличенной емкостью.
 Инновационная технология защиты от подделок гарантирует неизменно высокое качество HP.',20,40000,20,20,20,1),
(true,5,'11 PrintHeads',5,'Оригинальные лазерные картриджи HP с технологией JetIntelligence обеспечивают печать рекордного количества страниц с высокой скоростью. Можно выбрать доступные по цене модели с увеличенной емкостью. Ин
новационная технология защиты от подделок гарантирует неизменно высокое качество HP.',21,8768,21,21,21,1),
(true,5,'10 Cartrige',2,'Оригинальные лазерные картриджи HP с технологией JetIntelligence обеспечивают печать рекордного количества страниц с высокой скоростью. Можно выбрать доступные по цене модели с увеличенной емкостью. Инн
овационная технология защиты от подделок гарантирует неизменно высокое качество HP.',22,7620,22,22,22,1),
(true,1,'Монитор HP 27F Europe',5,'Этот сверхтонкий монитор с невероятно тонкими рамками, широчайшим углом обзора и встроенной аудиосистемой обеспечивает четкое изображение потрясающего качества, о котором вы давно мечтали. От п
...
(true,1,'Монитор HP 24F Europe',3,'Этот сверхтонкий монитор с невероятно тонкими рамками, широчайшим углом обзора и встроенной аудиосистемой обеспечивает четкое изображение потрясающего качества, о котором вы давно мечтали. От п
...
(true,1,'Монитор OMEN X 27',4,'Ты играешь. Мы это показываем.
...
(true,1,'Монитор HP X32 Gaming',5,'Играй лучше, дольше и комфортнее на наших превосходных игровых мониторах. Открой для себя заново игры высокой четкости благодаря экрану IPS, частоте 165 Гц, времени отклика 1 мс2, технологии AM
