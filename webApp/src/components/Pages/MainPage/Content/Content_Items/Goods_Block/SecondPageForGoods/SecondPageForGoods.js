...
const Goods = ({id,name,imageUrl,processor,ram,os,category,disc,price,ppm,type,dpi,format,printer_ram,inStock}) =>{
                ...
                <div   className = "pizza-block" >
                    <div className={''}>
                        <Link to={'/details'}>
                            ...
                            <img   className = "pizza-block__image hover__notebooks"
                                   src = {imageUrl}
                                   alt = "Pizza"/>
