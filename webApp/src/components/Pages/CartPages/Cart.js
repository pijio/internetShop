                    ...
                    <div className="container container--cart">
                        <div className="cart">
                            ...
                            <div className="content__items">
                                {
                                    groupedFirstItems.map((obj,index)=><CartItem
                                        {...obj}
                                        minus={onMinusItem}
                                        onRemoveItem={onRemoveItem}
                                        groupedAllItems={groupedAllItems}
                                        valueOfGoods={groupedAllItems[index].length}
                                       totalOnePrice={totalOnePrice[index]}  key={obj.id} id={obj.id}  name={obj.name} imageUrl={obj.imageUrl} processor={obj.processor}/>)
